...
## Summary
This note explains how to use [[Treadmill]] for combined PCOS and high triglycerides training with a focus on aerobic base work, strength training, and repeatable weekly structure.

## Key Points
- Main context: [[Treadmill]] sits inside [[Cardio Equipment Hub]] and should be used within the broader guidance in [[PCOS Exercise Guidance]].
